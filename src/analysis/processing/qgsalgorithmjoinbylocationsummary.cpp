...
void QgsJoinByLocationSummaryAlgorithm::initAlgorithm( const QVariantMap & )
{
  ...
  mAllSummaries << QObject::tr( "Count" )
                ...
                << QObject::tr( "Interquartile Range (IQR)" )
                << QObject::tr( "Count (Missing)" )
                << QObject::tr( "Count (Filled)" )
                << QObject::tr( "Minimum Length" )
                << QObject::tr( "Maximum Length" )
                << QObject::tr( "Mean Length" );
