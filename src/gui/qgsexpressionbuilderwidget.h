...
class GUI_EXPORT QgsExpressionBuilderWidget : public QWidget, private Ui::QgsExpressionBuilderWidgetBase
{
  ...
  public:
    ...
    //! \deprecated 3.14 this is now done automatically
    Q_DECL_DEPRECATED void loadFieldNames() {} SIP_DEPRECATED

    //! \deprecated 3.14 use expressionTree()->loadFieldNames() instead
     ...
     *  \since QGIS 2.12
     * \deprecated 3.14 this will not do anything, use setLayer() instead
     */
     ...
     * \deprecated 3.14 use expressionTree()->saveRecent() instead
     */
     ...
     * \deprecated 3.14 use expressionTree()->loadRecent() instead
     */
     ...
     * \deprecated 3.14 use expressionTree()->loadUserExpressions() instead
     * \since QGIS 3.12
     */
     ...
     * \deprecated 3.14 use expressionTree()->saveToUserExpressions() instead
     * \since QGIS 3.12
     */
     ...
     * \deprecated 3.14 use expressionTree()->removeFromUserExpressions() instead
     * \since QGIS 3.12
     */
  ...
  public slots:
     ...
     * \since QGIS 3.12
     * \deprecated 3.14 use expressionTree()->findExpressions instead
     */
