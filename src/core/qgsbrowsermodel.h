...
class CORE_EXPORT QgsBrowserModel : public QAbstractItemModel
{
  ...
  public:
    ...
    */
    ...
    /**
     * \deprecated 3.4 this method has no effect, and is dangerous to call in earlier QGIS versions. Any usage should be removed (and will have no harmful side-effects!).
     */
