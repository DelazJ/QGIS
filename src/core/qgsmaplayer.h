...
class CORE_EXPORT QgsMapLayer : public QObject
{
  ...
  public:
    ...
    enum StyleCategory
    {
      ...
      Masks              = 1 << 18, //!< Masks (since QGIS 3.20)
      AllStyleCategories = LayerConfiguration | Symbology | Symbology3D | Labeling | Fields | Forms | Actions |
                           MapTips | Diagrams | AttributeTable | Rendering | CustomProperties | GeometryOptions | Relations | Temporal | Legend | Elevation | Notes | Masks,
    };
